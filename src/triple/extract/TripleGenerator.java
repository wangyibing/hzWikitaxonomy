	...
	public static String GenerFromTR(int pageid, Tag tr)
	{
		...
		if(tags.size() == 2)
		{
			...
			case 1:
				...
				return SecondStandardize.GetTriples(pageid, predi, objc, InfoboxNode.UpperTitle, InfoboxNode.TRTitleNr);
			case 2:
		...
		else if(tags.size() == 1)
		{
					...
					TagChild.containDescendantTag(tags.get(0).tag, "tr") == false)
			{
				...
				SecondStandardize.PageId = pageid;
				return SecondStandardize.getTripleFromSgl(context, pageid);
			}
			// subTitle
			if(tName.equals("th"))
			{
